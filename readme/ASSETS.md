...
截图共用 `readme/screenshots/`；`overview.png` 将三张原始截图等比例缩小并横向拼接，保证 README 中始终单排展示，原始单张截图保留。README 翻译分别为 `README_en-US.md` 和 `README_zh-TW.md`。README 翻译不代表应用界面已经支持对应语言。
